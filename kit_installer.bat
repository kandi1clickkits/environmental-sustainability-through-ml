...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/environmental-sustainability-through-ml/releases/download/v1.0.0/environmental-sustainability-through-ml.zip
SET REPO_DEPENDENCIES_URL=https://github.com/kandi1clickkits/environmental-sustainability-through-ml/raw/main/requirements.txt
SET REPO_NAME=environmental-sustainability-through-ml.zip
SET EXTRACTED_REPO_DIR=environmental-sustainability-through-ml
SET NOTEBOOK_NAME=Environmental_Sustainability_IoTdata.ipynb
where /q python
IF ERRORLEVEL 1 (
	ECHO==========================================================================
